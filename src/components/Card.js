...
function Card() {
  return (
    <div className="shadow-lg grid grid-cols-3 py-14 gap-5 max-w-4xl h-44 ml-32 bg-card rounded-xl -mt-24 font-Poppins">
      <div className="space-y-3 border-r-2 border-secondary border-opacity-50">
